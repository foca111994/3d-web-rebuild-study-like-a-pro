  ...
  return (
    <main className={`mode-courses-page mode-courses-page--${mode}`}>
      <header className="mode-courses-header">
        <a href="/" className="mode-courses-brand" aria-label="Volver al inicio"><img src="/brand/study-like-a-pro-sky.png" alt="Study Like a Pro" /><span>/ {start ? "Start Smart" : "Ninja Mode"}</span></a>
