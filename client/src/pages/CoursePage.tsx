...
export default function CoursePage() {
  ...
  return (
    <main className={`course-page course-page--${isWarMode ? "ninja" : "start"}`}>
      ...
      <section className="course-final-cta"><span>{language === "en" ? "Final / Next step" : "Final / Próximo paso"}</span><h2>{language === "en" ? <>Is this the skill<br />you want to learn?</> : <>¿Es la skill<br />que querés aprender?</>}</h2><a href={conversionUrl} target="_blank" rel="noreferrer">{language === "en" ? "Check availability" : "Ver disponibilidad"} <ArrowUpRight size={20} /></a></section>
