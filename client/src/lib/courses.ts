...
export const COURSES: Course[] = [
  {
    ...
    officialUrl: "https://studylikeapro.art/car-detailing",
  ...
  },
  {
    ...
    officialUrl: "https://studylikeapro.art/academia-del-macrame",
    status: "Curso disponible",
    featured: true,
  },
  {
  ...
  },
  {
    ...
    title: "El Arte de Hablar en Público",
    slug: "el-arte-de-hablar-en-publico",
    description: "Ordená tus ideas, fortalecé tu presencia y comunicá con más claridad.",
    longDescription: "Un entrenamiento para construir discursos con más claridad, presencia e influencia. Combina oratoria, persuasión e inteligencia artificial con recursos aplicables a presentaciones, liderazgo y ventas.",
    officialUrl: "https://studylikeapro.art/cursos-courses",
    status: "Ver disponibilidad",
  },
  {
    ...
    modeLabel: "Ninja / Ninja Mode",
    category: "Bienestar",
    title: "Yoga, Medicina para el Espíritu",
    slug: "yoga-medicina-para-el-espiritu",
    description: "Una práctica para bajar revoluciones, reconectar con tu cuerpo y encontrar más calma.",
    longDescription: "Una propuesta para trabajar bienestar, enfoque y equilibrio desde un lugar más consciente y sostenido.",
    officialUrl: "https://studylikeapro.art/cursos-courses",
    status: "Ver disponibilidad",
  },
  {
  ...
  },
  {
    ...
    mode: "Modo 2",
    modeLabel: "Ninja / Ninja Mode",
    category: "Educación & familia",
    title: "Gestión Emocional Para Niños",
    slug: "gestion-emocional-para-ninos",
    description: "Más herramientas, más calma y menos frustración para acompañar el día a día.",
    longDescription: "Un curso para entender mejor lo que sienten los chicos y acompañarlos con más recursos en casa o en contextos educativos.",
    officialUrl: "https://studylikeapro.art/cursos-courses",
    status: "Ver disponibilidad",
  },
  {
    ...
    officialUrl: "https://studylikeapro.art/el-rentable-negocio-de-la-sublimacion",
    status: "Curso disponible",
  },
];
